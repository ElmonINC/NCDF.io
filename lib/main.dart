                            ...
                            SizedBox(
                              ...
                              child: FilledButton.icon(
                                onPressed: () => Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        PersonaScreen(email: email.text.trim()),
                                  ),
                                ),
  ...
  Widget build(BuildContext context) => InkWell(
    ...
    child: AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: const Color(0xFFE1E9E6), width: 1),
        boxShadow: [
          BoxShadow(
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Row(
      children: [
        ...
        Text(
          adminVisible ? 'Admin enabled' : 'Standard access',
          style: TextStyle(
            color: adminVisible ? teal : Colors.blueGrey,
            fontSize: 11,
            fontWeight: FontWeight.w700,
          ),
        ),
...
class _BuilderConsoleGateState extends State<BuilderConsoleGate> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      title: const Text('Builder / Superadmin access'),
              ...
              child: verified
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        const Text(
                          'This is a separate administrative surface for builders and superadmins. Production access must require backend MFA, device trust, and server-side permission checks.',
                          style: TextStyle(
                        ...
                        TextField(
                          ...
                          obscureText: true,
                          decoration: const InputDecoration(
                            labelText: 'Builder verification code',
                        ...
                        SizedBox(
                          ...
                          child: FilledButton.icon(
                            ...
                            label: const Text('Verify and open console'),
                          ),
                        ),
                      ],
                    ),
...
class BuilderConsole extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      ...
      const Text(
        'The operational surface for managing modules, permissions, and releases.',
        ...
        child: Column(
          children: [
            _ConsoleAction(
              ...
              detail: 'Enable, pause, or configure NCDF modules',
            ),
            _ConsoleAction(
              icon: Icons.policy_outlined,
              title: 'Permission policies',
              detail: 'Review role and permission policy changes',
            ),
            _ConsoleAction(
              icon: Icons.cloud_upload_outlined,
              title: 'Release management',
              detail: 'Review builds and deployment approvals',
            ),
            _ConsoleAction(
              icon: Icons.storage_outlined,
              title: 'Data operations',
              detail: 'Backups, retention, and export controls',
            ),
          ],
        ),
      ),
      ...
      Panel(
        ...
        child: Row(
          children: [
            const Icon(Icons.timer_outlined, color: teal),
            const SizedBox(width: 10),
            const Expanded(
              child: Text(
...
class _ConsoleAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
    ...
    trailing: const Icon(Icons.arrow_forward_ios, color: teal, size: 14),
  );
}
...
class _WorkspaceScreenState extends State<WorkspaceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final pages = admin
        ...
        : personaPages(widget.persona.name);
    return Scaffold(
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
...
class AdminControlCenter extends StatelessWidget {
        ...
        builder: (context, constraints) {
          ...
          final institutions = Panel(
            ...
            action: _AdminActionButton(
              ...
              onPressed: () =>
                  _act(context, 'Started institution registration'),
            ),
            child: Column(
              children: [
                _InstitutionRow(
          ...
          return stacked
              ? Column(
                  children: [institutions, const SizedBox(height: 18), users],
                )
              : Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
  ...
  void _act(BuildContext context, String action) {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('$action started')));
  }
}
...
class _InstitutionRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
    ...
    trailing: Text(
      status,
      style: TextStyle(color: tone, fontWeight: FontWeight.w700, fontSize: 11),
    ),
  );
}
                    ...
                    children: [
                      ...
                      FilledButton.icon(
                        style: FilledButton.styleFrom(
                          backgroundColor: const Color(0xFF8AD3C8),
                          foregroundColor: navy,
                        ),
                        onPressed: () => _performAction(
                          context,
                          content.primaryAction,
                          content.primaryModule,
                        ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(card.icon, color: ink, size: 20),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
...
const _personaContent = {
  'Founder': PersonaContent(
    ...
    summary:
        'Bring your venture closer to the capital, people, and decisions that can move it forward.',
    eyebrow: 'Founder launchpad',
    heroTitle: 'Your venture readiness is 65% complete.',
    heroBody:
        'Complete your profile once and make your story easier for investors, mentors, and partners to act on.',
    ...
    cards: [
      PersonaAction(
        'Apply for funding',
        '3 open programs match your sector',
        'Opened funding application',
        Icons.currency_exchange,
        Color(0xFFEAF4ED),
      ),
      PersonaAction(
        'Prepare your pitch',
        'Use the investor-ready checklist',
        'Opened pitch checklist',
        Icons.present_to_all_outlined,
        Color(0xFFFFF1DB),
      ),
      PersonaAction(
        'Find a mentor',
        '8 mentors are available this month',
        'Opened mentor matching',
        Icons.diversity_3_outlined,
        Color(0xFFEDEBFA),
      ),
    ],
  ...
  'Investor': PersonaContent(
    ...
    summary:
        'A focused deal room for discovering credible ventures and moving from interest to diligence.',
    eyebrow: 'Investor deal room',
    heroTitle: '12 ventures match your thesis.',
    heroBody:
        'Review curated opportunities, compare readiness, and request a conversation with founders in one place.',
    ...
    cards: [
      PersonaAction(
        'Review shortlist',
        '4 founder profiles need your review',
        'Opened investment shortlist',
        Icons.fact_check_outlined,
        Color(0xFFFFF1DB),
      ),
      PersonaAction(
        'Request diligence',
        'Start a secure information request',
        'Started diligence request',
        Icons.manage_search_outlined,
        Color(0xFFE3F2F4),
      ),
      PersonaAction(
        'Schedule founder call',
        'Coordinate your next conversation',
        'Opened founder scheduling',
  ...
  'Mentor': PersonaContent(
    ...
    summary:
        'Turn expertise into structured sessions, measurable progress, and stronger ventures.',
    eyebrow: 'Mentor studio',
    heroTitle: '5 founders are looking for your expertise.',
    heroBody:
        'Choose focused requests, prepare before each session, and keep momentum visible after the conversation.',
    ...
    cards: [
      PersonaAction(
        'Book a session',
        'Your calendar has 3 open slots',
        'Opened mentor calendar',
        Icons.calendar_month_outlined,
        Color(0xFFEDEBFA),
      ),
      PersonaAction(
        'Review founder goals',
        'See context before you respond',
        'Opened founder goals',
        Icons.track_changes_outlined,
        Color(0xFFE3F2F4),
      ),
      PersonaAction(
        'Share a resource',
        'Add a playbook to the community',
        'Opened resource library',
  ...
  'Partner': PersonaContent(
    ...
    summary:
        'Turn your organization’s reach, programs, and resources into visible opportunities for the NCDF network.',
    eyebrow: 'Partner workspace',
    heroTitle: '3 collaboration opportunities are ready.',
    heroBody:
        'Create a program, connect with qualified ventures, and measure the value your partnership creates.',
    ...
    cards: [
      PersonaAction(
        'Launch a program',
        'Invite ventures into your next initiative',
        'Opened program builder',
        Icons.add_task_outlined,
        Color(0xFFE3F2F4),
      ),
      PersonaAction(
        'Meet the network',
        'Find ventures aligned to your goals',
        'Opened partner matching',
        Icons.groups_outlined,
        Color(0xFFEAF4ED),
      ),
      PersonaAction(
        'View impact report',
        'See your partnership contribution',
        'Opened impact report',
    ...
    children: [
      ...
      LayoutBuilder(
        builder: (context, constraints) {
            ...
            child: Column(
              children: [
                SwitchListTile(
                  ...
                  subtitle: const Text('Administrators and security operators'),
                  value: mfaRequired,
                  onChanged: (value) => update(
                    value ? 'Enabled mandatory MFA' : 'Disabled mandatory MFA',
                    () => mfaRequired = value,
                  ),
                ),
                SwitchListTile(
                  ...
                  subtitle: const Text('Notify admins about unusual activity'),
                ...
                SwitchListTile(
                  ...
                  subtitle: const Text('Pause data changes during an incident'),
                  value: readOnlyMode,
                  onChanged: (value) => update(
                    value
          ...
          return stacked
              ? Column(
                  children: [controls, const SizedBox(height: 18), posture],
                )
              : Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
